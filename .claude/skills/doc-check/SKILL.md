...
| `infra/os/` | `docs/infra/platform.md` · `docs/infra/system.md` 4장 · `docs/infra/runbook.md` 9장 | firewalld 포트 · 계정 UID · GID · 정기 작업 시각 · 보존 · SELinux 설정 · NFS 공유 대상(옛 단일 노드)이 설계서와 같은가 |
| `infra/backup/` | `docs/infra/platform.md` 5 · 7장 · `docs/infra/runbook.md` 5장 · 9.3 · `docs/infra/tech-stack.md` 3장 | 정기 작업 시각 · 보존(로컬 개수 · S3 수명 주기) · 목적지 · 역할 정책(`aws/`)이 설계서 · 절차서와 같은가 |
...
| 바뀐 것 | 볼 문서 |
| --- | --- |
| `.github/workflows/` | `docs/git/branch-strategy.md` · `docs/architecture/testing.md` · `docs/infra/runbook.md` · `docs/tech-stack.md` |
| `.github/ISSUE_TEMPLATE/` · `PULL_REQUEST_TEMPLATE.md` | `docs/git/issue-guide.md` · `docs/git/pr-guide.md` |
| `.claude/agents/` · `.claude/skills/` | `docs/workflow.md` · 루트 `CLAUDE.md` 프로젝트 구조 |
...
| 인프라 기능 `INF-…` | `docs/features/infra.md` · `docs/features/overview.md` · `docs/infra/system.md` 1장 · `docs/git/branch-strategy.md` · `docs/git/commit-convention.md` · `.github/pull_request_template.md` · `.claude/skills/slice-start/SKILL.md` |
