...
> ※ 설계 근거는 `docs/features/infra.md`를, 서버 · 네트워크 · 계정 · 정기 작업의 설계는 `docs/infra/platform.md`를 따른다. 지표와 알림은 `docs/infra/observability.md`를 따른다 — 미작성이다. 그 전까지 지표 이름은 인프라 API 명세 1장, 권장 알림 규칙은 2장이 갖는다.
> 작성 기준일 : 2026년 8월
