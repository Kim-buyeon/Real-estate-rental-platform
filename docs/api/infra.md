...
> 노출 엔드포인트, 알림 발송(차기 범위)
> INF-01 (INF-05 행은 차기 범위)
>
...
**INF-05 행은 차기 범위다**(2026-09-19 결정). 이번 구간에 구현하는 것은 INF-01 readiness 하나다. INF-05 행은 정의를 보존하려고 남긴다.
...
> **차기 범위 — INF-05**(2026-09-19 결정). 정의를 보존하려고 남긴다. 지금 작업의 근거로 쓰지 않는다.
